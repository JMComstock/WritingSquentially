...
//                              If a datasource is opened in APPEND mode, then the first write will take place stating
//                              at the end of the datasource, rather than at position.  After the write, the position
...
//            size() - returns the size of the attached datasource
            ...
            System.out.println("in2 = " + readBuffer.getInt());
            readBuffer.flip();
